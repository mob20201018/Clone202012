...
const inviteCodes = [
  `S5KkcOn5AjDOJYUOl_Z5W@S5KkcHmVwgiqXZWuP3r51@S5KkcRx4fpwbVcU_xwP4IcA`,
  `S76EvFUBYtFXVIBM@S5KkcHmVwgiqXZWuP3r51@S5KkcRx4fpwbVcU_xwP4IcA`,
  `S76EvFUBYtFXVIBM@S5KkcOn5AjDOJYUOl_Z5W@S5KkcRx4fpwbVcU_xwP4IcA`,
  `S76EvFUBYtFXVIBM@S5KkcOn5AjDOJYUOl_Z5W@S5KkcHmVwgiqXZWuP3r51`,
]
!(async () => {
  $.tuanList = []
  await requireConfig();
